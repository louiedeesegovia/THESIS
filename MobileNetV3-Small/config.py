...
class Config:
    ...
    batch_size = 4  # Modified for MobileNetV3-Small
    gpu_id = 0
    ...
    weight_decay = 5e-5
    momentum = 0.9
    # setting for cnn - MODIFIED FOR MOBILENETV3
    image_size = 224
    backbone_type = 'mobilenetv3_small'  # New parameter
    resnet_layers = 18  # Kept for compatibility
    dropout = 0.5
    pool_dropout = 0.5
    ...
    if len(pattern_list) == 1:
        ...
        prefix = 'mobilenetv3_small'  # Modified prefix
        if use_multipattern:
