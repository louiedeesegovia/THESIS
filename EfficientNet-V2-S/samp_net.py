...
def build_efficientnet_v2_s(pretrained=True):
    """
    Build EfficientNet-V2-S backbone
    Output channel: 1280
    """
    if pretrained:
...
class SAMPNet(nn.Module):
    def __init__(self, cfg, pretrained=True):
        ...
        # EfficientNet-V2-S output channel is 1280
        input_channel = 1280
        sal_dim = 512
        ...
        self.backbone = build_efficientnet_v2_s(pretrained=pretrained)
