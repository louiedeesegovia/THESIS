...
def build_inception_v1(pretrained=False):
    ...
    # Remove the final avgpool, dropout and fc layers
    # Keep only the convolutional layers up to the last inception module
...
class SAMPNet(nn.Module):
    def __init__(self, cfg, pretrained=True):
        ...
        # Determine input channel based on backbone type
