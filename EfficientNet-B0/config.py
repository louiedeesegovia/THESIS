...
class Config:
    ...
    gpu_id = 0
    num_workers = 0  # Changed from 8 to 0
    ...
    # setting for cnn
    image_size = 224
    backbone_type = 'efficientnet_b0'  # Changed from resnet to efficientnet_b0
    resnet_layers = 18  # Keep for backward compatibility
    dropout = 0.5
    pool_dropout = 0.5
    ...
    if len(pattern_list) == 1:
        ...
        prefix = 'efficientnet_b0'  # Changed prefix
        if use_multipattern:
