...
def evaluation_on_cadb(model, cfg):
    ...
    # ========================================================================
    # BENCHMARKING: FPS and FLOPs Measurement
    # ========================================================================
    print()
    print('='*80)
    ...
    fps = 100 / (end - start)
    avg_inference_time = (end - start) / 100 * 1000  # in milliseconds
    
    print(f'Inference FPS: {fps:.2f}')
    print(f'Average Inference Time: {avg_inference_time:.2f} ms')
    
    # FLOPs and Parameters Measurement
    ...
    if device.type == 'cuda':
        ...
        print(f'GPU Memory Usage: {peak_memory_mb:.2f} MB')
...
if __name__ == '__main__':
    ...
    weight_file = 'C:/Users/segov/Music/SAMP-Net/SAMPNet/experiments/regnetx400mf_samp_aaff_wemd/checkpoints/model-best.pth'
