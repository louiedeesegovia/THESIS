...
class Config:
    ...
    batch_size = 4  # Reduced for laptop training
    gpu_id = 0
    num_workers = 0  # Set to 0 for laptop compatibility
    ...
    # setting for cnn
    image_size = 224
    backbone = 'regnetx_400mf'  # Changed from resnet_layers
    dropout = 0.5
    pool_dropout = 0.5
    ...
    prefix = 'regnetx400mf'  # Updated prefix for RegNetX
